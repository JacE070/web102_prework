...
contributionsCard.textContent = GAMES_JSON.reduce((total, game) => {
...
const moneyStr = `$${GAMES_JSON.reduce((total, game) => {
  return total + game.pledged;
}, 0).toLocaleString()}`;
raisedCard.textContent = moneyStr;
...
const unfundedGamesString =
  unfundedGames.length === 1
    ? `A total of $${moneyStr} has been raised for 4 games. Currently, ${1} game remains unfunded. We need your help to fund these amazing games!`
    : `A total of $${moneyStr} has been raised for 4 games. Currently, ${unfundedGames.length} games remain unfunded. We need your help to fund these amazing games!`;
